...
run_all.py
----------
Run all 8 Python SDK demos in sequence and print a pass/fail summary.

Usage:
    python run_all.py              # run all demos
    python run_all.py --only 1 4   # run demos 1 and 4 only
    python run_all.py --skip 8     # skip demo 8 (semantic cache)
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Run Portkey local POC demos")
...
def run():
    ...
    print("\n" + "█" * 64)
    print("  Portkey Local POC — Python SDK Demos")
    print("  Gateway : http://localhost:8787/v1")
    print("█" * 64)
