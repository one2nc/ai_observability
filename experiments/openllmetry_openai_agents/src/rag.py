...
# Keep OpenAI hosted trace upload disabled. A Bifrost virtual key is valid for
# gateway model calls, not for OpenAI's /v1/traces/ingest endpoint. The local
# OpenTelemetry processor is installed in src/instrument.py.
